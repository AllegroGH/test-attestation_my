...
beforeEach(() => {
  ...
  const result1 = execFileSync('bin/weather.js', ['__fixtures__/weather1.csv'], options);
  rows1 = result1.trim().split('\n');

  const result2 = execFileSync('bin/weather.js', ['__fixtures__/weather2.csv'], options);
